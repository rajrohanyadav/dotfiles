# Generated by Powerlevel10k configuration wizard on 2024-02-07 at 21:16 PST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_GO_VERSION_DELIMITER
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="$p"
  # Blue current directory.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$blue
  # typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=2
  # typeset -g POWERLEVEL9K_SHORTEN_STRATEGY="truncate_middle"
  typeset -g POWERLEVEL9K_VCS_GIT_ICON='%fon %F{040}\uf1d3 '
  typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='%fon %F{040}\uf09b '
  typeset -g POWERLEVEL9K_VCS_GIT_BITBUCKET_ICON='%fon %F{040}\uf171 '
  typeset -g POWERLEVEL9K_VCS_GIT_GIT_GITLAB_ICON='%fon %F{040}\uf296 '
